...
get_filename_component(_pg_core_name "${PG_CORE_SO_PATH}" NAME)
message(STATUS "[PG] Staging ${_pg_core_name} -> ${STAGING_DIR}")
file(COPY "${PG_CORE_SO_PATH}" DESTINATION "${STAGING_DIR}"
